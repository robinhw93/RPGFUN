...
- Completing the final stage clears active combat, records the adventure ID on the character, and marks the adventure completed. Story-adventure availability treats that persistent ID as terminal: the adventure stays visible with a Completed treatment but both UI and the `beginAdventure` command reject replay.
