...
- `src/components/town/` owns the illustrated Arkenfall hub, vendor tabs, recipe/material presentation, centered floating purchase confirmation, inline crafting/error feedback, and tavern-rest screen. It calls shared game transitions and does not mutate Inventory, gold, or carried Health itself.
