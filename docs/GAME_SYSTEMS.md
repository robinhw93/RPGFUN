...
- **Alchemist — Ray Charlston** has **Shop** and **Brew** tabs. Purchases use the same persistent Inventory/gold rules, while Brew uses recipes assigned to the Alchemist. Selected vendor-service tabs use the shared gold interface treatment at both vendors.
