...
Cooldowns are measured in player turns. **None** means the ability can be repeated in the same turn as long as Energy, targeting requirements, and the six-action player-turn limit allow it.
...
Eight magical weapons and off-hands from Adventures 4 and 6–12 are also sold by the Jeweler after the same completion gate while retaining their Jewelcrafting recipes.
