...
export const ABILITIES: Record<string, Ability> = {
  ...
  CrushingImpact: {
    range: "melee",
    id: "CrushingImpact", name: "Crushing Impact", description: "Deal Physical Damage equal to your Guard and remove every buff from the target.", energyCost: 0,
    target: "enemy", damageFromSelfStatusStacks: { status: "guard", multiplier: 1, damageType: "physical" }, removeAllTargetBuffs: true,
...
const TALENT_NODES: Talent[] = [
  ...
  { id: "talent_195", name: "Scorched Wounds", description: "Whenever you critically strike, apply 1 Burn.", branch: "brute", kind: "passive", tier: 10, cost: 1, requires: ["talent_190"], position: { x: 13.095238095238097, y: 46.02272727272727 }, icon: "✦", shape: "circle", combat: { triggers: [{ id: "scorched-wounds", name: "Scorched Wounds", description: "Critical strikes apply 1 Burn.", event: "on_crit", effects: [{ type: "apply_status", status: createStatusEffect("burn"), target: "target" }] }] } },
...
const TALENT_TREE_LAYOUT: Record<string, Talent["position"]> = {
  ...
  talent_85: { x: 42.632, y: 40.5 },
  talent_86: { x: 45.789, y: 40.5 },
  ...
  talent_92: { x: 40.526, y: 40.5 },
  talent_93: { x: 47.895, y: 40.5 },
  talent_94: { x: 35.263, y: 38.5 },
  talent_95: { x: 53.158, y: 38.5 },
  talent_96: { x: 42.632, y: 37.5 },
  talent_97: { x: 45.789, y: 37.5 },
  talent_98: { x: 40.526, y: 37.5 },
  talent_99: { x: 47.895, y: 37.5 },
  talent_100: { x: 52.105, y: 34 },
  talent_101: { x: 45.789, y: 34 },
  talent_102: { x: 42.632, y: 34 },
  talent_103: { x: 36.316, y: 34 },
  talent_104: { x: 39.474, y: 34 },
  talent_105: { x: 48.947, y: 34 },
  talent_106: { x: 42.632, y: 30.5 },
  talent_107: { x: 45.789, y: 30.5 },
