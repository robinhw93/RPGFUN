...
export const TALENT_TREE_CANVAS = { width: 3410, height: 1950 } as const;

export const TALENTS: Talent[] = [
  { id: "origin", name: "Wayfarer's Spark", description: "Your first step. Unlocks Strike and Guard.", branch: "core", kind: "class", tier: 0, cost: 0, requires: [], position: { x: 32.258, y: 38.462 }, icon: "✦", shape: "square" },
  { id: "brute_1", name: "Brute", description: "+2 Strength.", branch: "brute", kind: "class", tier: 1, cost: 1, requires: ["origin"], position: { x: 27.419, y: 38.462 }, icon: "◆", shape: "square", combat: { passive: { stats: { strength: 2 } } } },
  { id: "shadow_1", name: "Shadow", description: "+2 Agility. Unlocks Quick Slash.", branch: "shadow", kind: "class", tier: 1, cost: 1, requires: ["origin"], position: { x: 37.097, y: 38.462 }, icon: "◈", shape: "square", abilityId: "quickSlash", combat: { passive: { stats: { agility: 2 } } } },
  { id: "arcanist_1", name: "Arcanist", description: "+2 Intelligence.", branch: "arcanist", kind: "class", tier: 1, cost: 1, requires: ["origin"], position: { x: 32.258, y: 30.769 }, icon: "✧", shape: "square", combat: { passive: { stats: { intelligence: 2 } } } },
  { id: "talent_1", name: "Immaculate Timing", description: "+2 Agility. +5 Initiative.", branch: "shadow", kind: "passive", tier: 2, cost: 1, requires: ["shadow_1"], position: { x: 41.935, y: 38.462 }, icon: "✦", shape: "circle", combat: { passive: { stats: { agility: 2 }, initiative: 5 } } },
  { id: "talent_2", name: "Twin Strike", description: "Strike twice for 50% Physical Power per hit. Each hit triggers on-hit effects.", branch: "shadow", kind: "ability", tier: 3, cost: 1, requires: ["talent_1"], position: { x: 45.967, y: 32.692 }, icon: "✦", shape: "square", abilityId: "TwinStrike" },
  { id: "talent_3", name: "Poison Stab", description: "Deal 50% Physical Power as damage and apply 1 Poison.", branch: "shadow", kind: "ability", tier: 3, cost: 1, requires: ["talent_1"], position: { x: 45.967, y: 44.231 }, icon: "✦", shape: "square", abilityId: "PoisonStab" },
  { id: "talent_4", name: "Honed Skills", description: "+2% Critical Strike Chance.", branch: "shadow", kind: "passive", tier: 4, cost: 1, requires: ["talent_2"], position: { x: 50, y: 32.692 }, icon: "✦", shape: "circle", combat: { passive: { critChance: 0.02 } } },
  { id: "talent_5", name: "Precision", description: "+2% Hit Chance.", branch: "shadow", kind: "passive", tier: 4, cost: 1, requires: ["talent_3"], position: { x: 50, y: 44.231 }, icon: "✦", shape: "circle", combat: { passive: { hitChance: 0.02 } } },
  { id: "talent_6", name: "Evasion", description: "+2% Dodge Chance.", branch: "shadow", kind: "passive", tier: 5, cost: 1, requires: ["talent_4"], position: { x: 50, y: 25.962 }, icon: "✦", shape: "circle", combat: { passive: { dodgeChance: 0.02 } } },
  { id: "talent_7", name: "Stamina", description: "+1 Max Energy.", branch: "shadow", kind: "passive", tier: 5, cost: 1, requires: ["talent_4"], position: { x: 54.032, y: 32.692 }, icon: "✦", shape: "circle", combat: { passive: { maxEnergy: 1 } } },
  { id: "talent_8", name: "Setup", description: "+2 Initiative.", branch: "shadow", kind: "passive", tier: 5, cost: 1, requires: ["talent_5"], position: { x: 50, y: 50.962 }, icon: "✦", shape: "circle", combat: { passive: { initiative: 2 } } },
  { id: "talent_9", name: "Spell Dodger", description: "+2 Magic Resistance.", branch: "shadow", kind: "passive", tier: 5, cost: 1, requires: ["talent_5"], position: { x: 54.032, y: 44.231 }, icon: "✦", shape: "circle", combat: { passive: { magicResistance: 2 } } },
  { id: "talent_10", name: "Poison Cloud", description: "Apply 1 Poison to all enemies without dealing direct damage.", branch: "shadow", kind: "ability", tier: 6, cost: 1, requires: ["talent_9"], position: { x: 58.065, y: 44.231 }, icon: "✦", shape: "square", abilityId: "PoisonCloud" },
  { id: "talent_11", name: "Stealth", description: "Enemies cannot target you until the end of your next turn.", branch: "shadow", kind: "ability", tier: 6, cost: 1, requires: ["talent_7"], position: { x: 58.064, y: 32.692 }, icon: "✦", shape: "square", abilityId: "Stealth" },
  { id: "talent_12", name: "Poison Coating", description: "Each hit has a 50% chance to apply 1 Poison.", branch: "shadow", kind: "passive", tier: 6, cost: 1, requires: ["talent_8"], position: { x: 54.032, y: 56.731 }, icon: "✦", shape: "circle", combat: { triggers: [{ id: "poison-coating", name: "Poison Coating", description: "Each hit has a 50% chance to apply 1 Poison.", event: "on_hit", chance: 0.5, effects: [{ type: "apply_status", status: createStatusEffect("poison"), target: "target" }] }] } },
  { id: "talent_13", name: "Adrenaline", description: "Each hit has a 10% chance to restore 1 Energy.", branch: "shadow", kind: "passive", tier: 6, cost: 1, requires: ["talent_6"], position: { x: 54.032, y: 20.192 }, icon: "✦", shape: "circle", combat: { triggers: [{ id: "adrenaline", name: "Adrenaline", description: "Each hit has a 10% chance to restore 1 Energy.", event: "on_hit", chance: 0.1, effects: [{ type: "gain_energy", amount: 1, target: "self" }] }] } },
  { id: "talent_14", name: "Evasion", description: "Increase your Dodge Chance by 60% until your next turn.", branch: "shadow", kind: "ability", tier: 7, cost: 1, requires: ["talent_13"], position: { x: 58.064, y: 20.192 }, icon: "✦", shape: "square", abilityId: "Evasion" },
  { id: "talent_15", name: "Neurotoxin", description: "Stun a Poisoned enemy.", branch: "shadow", kind: "ability", tier: 7, cost: 1, requires: ["talent_12"], position: { x: 58.065, y: 56.731 }, icon: "✦", shape: "square", abilityId: "Neurotoxin" },
  { id: "talent_16", name: "Opportunist", description: "Deal 50% more damage while attacking from Stealth.", branch: "shadow", kind: "passive", tier: 7, cost: 1, requires: ["talent_11"], position: { x: 62.097, y: 32.692 }, icon: "✦", shape: "circle", combat: { damageModifiers: [{ id: "opportunist", name: "Opportunist", description: "Deal 50% more damage while attacking from Stealth.", multiplier: 1.5, attackerHasAnyStatus: ["stealth"] }] } },
  { id: "talent_17", name: "Blisters", description: "Deal 20% more Physical Damage to Poisoned enemies.", branch: "shadow", kind: "passive", tier: 7, cost: 1, requires: ["talent_10"], position: { x: 62.097, y: 44.231 }, icon: "✦", shape: "circle", combat: { damageModifiers: [{ id: "blisters", name: "Blisters", description: "Deal 20% more Physical Damage to Poisoned enemies.", multiplier: 1.2, damageTypes: ["physical"], targetHasAnyStatus: ["poison"] }] } },
  { id: "talent_18", name: "Agile", description: "+2 Agility.", branch: "shadow", kind: "passive", tier: 8, cost: 1, requires: ["talent_14"], position: { x: 62.097, y: 20.192 }, icon: "✦", shape: "circle", combat: { passive: { stats: { agility: 2 } } } },
  { id: "talent_19", name: "Smarts", description: "+2 Intelligence.", branch: "shadow", kind: "passive", tier: 8, cost: 1, requires: ["talent_15"], position: { x: 62.097, y: 56.731 }, icon: "✦", shape: "circle", combat: { passive: { stats: { intelligence: 2 } } } },
  { id: "talent_20", name: "Venomous Strike", description: "Deal 100% Physical Power as damage and apply 2 Poison. Deals double damage if the target is already Poisoned.", branch: "shadow", kind: "ability", tier: 9, cost: 1, requires: ["talent_19"], position: { x: 66.129, y: 62.5 }, icon: "✦", shape: "square", abilityId: "VenomousStrike" },
  { id: "talent_21", name: "Potency", description: "Your Poison deals 10% more damage.", branch: "shadow", kind: "passive", tier: 9, cost: 1, requires: ["talent_19"], position: { x: 66.129, y: 50.962 }, icon: "✦", shape: "circle", effectNotes: "Your Poison deals 10% more damage.", combat: { passive: { statusDamage: { poison: 0.1 } } } },
  { id: "talent_22", name: "Potency", description: "Your Poison deals 10% more damage.", branch: "shadow", kind: "passive", tier: 8, cost: 1, requires: ["talent_17"], position: { x: 66.129, y: 44.231 }, icon: "✦", shape: "circle", effectNotes: "Your Poison deals 10% more damage.", combat: { passive: { statusDamage: { poison: 0.1 } } } },
  { id: "talent_23", name: "Electrified", description: "Your attacks have a 20% chance to apply Electrified.", branch: "shadow", kind: "passive", tier: 9, cost: 1, requires: ["talent_18"], position: { x: 66.129, y: 25.962 }, icon: "✦", shape: "circle", effectNotes: "Your attacks have a 20% chance to apply Electrified.", combat: { triggers: [{ id: "electrified-strikes", name: "Electrified", description: "Each hit has a 20% chance to apply Electrified.", event: "on_hit", chance: 0.2, effects: [{ type: "apply_status", status: createStatusEffect("electrified"), target: "target" }] }] } },
  { id: "talent_24", name: "Flurry", description: "Attack five times for 50% Physical Power per hit. Each hit chooses a random enemy and can trigger on-hit effects.", branch: "shadow", kind: "ability", tier: 9, cost: 1, requires: ["talent_18"], position: { x: 66.129, y: 14.423 }, icon: "✦", shape: "square", abilityId: "Flurry", effectNotes: "Cooldown: 2 turns\nCost: 4 Energy\nAttack five times for 50% Physical Power per hit. Each hit chooses a random enemy and can trigger on-hit effects." },
  { id: "talent_25", name: "Energized", description: "+1 Energy gained at the start of your turn.", branch: "shadow", kind: "passive", tier: 8, cost: 1, requires: ["talent_16"], position: { x: 66.129, y: 32.692 }, icon: "✦", shape: "circle", effectNotes: "+1 Energy gained at the start of your turn.", combat: { passive: { energyRegen: 1 } } },
  { id: "talent_26", name: "Ambush", description: "Can only be used while Stealthed. Deal 150% Physical Power as damage with +50% Critical Strike Chance.", branch: "shadow", kind: "ability", tier: 9, cost: 1, requires: ["talent_25"], position: { x: 70.161, y: 32.692 }, icon: "✦", shape: "square", abilityId: "Ambush", effectNotes: "Cost: 2 Energy\nCan only be used while Stealthed. Deal 150% Physical Power as damage with +50% Critical Strike Chance." },
  { id: "talent_27", name: "Toxic Explosion", description: "Detonate all Poison on the target, dealing its full duration damage immediately and removing Poison.", branch: "shadow", kind: "ability", tier: 9, cost: 1, requires: ["talent_22"], position: { x: 70.161, y: 44.231 }, icon: "✦", shape: "square", abilityId: "ToxicExplosion", effectNotes: "Cost: 5 Energy\nCooldown: 2 turns\nDetonate all Poison on the target, dealing its full duration damage immediately and removing Poison." },
  { id: "talent_28", name: "Longevity", description: "Toxic Explosion no longer removes Poison from the target.", branch: "shadow", kind: "passive", tier: 10, cost: 1, requires: ["talent_27"], position: { x: 70.16129032258065, y: 50.96153846153846 }, icon: "✦", shape: "circle", effectNotes: "Toxic Explosion no longer removes Poison from the target.", combat: { passive: { preserveStatusOnDetonation: ["poison"] } } },
];
