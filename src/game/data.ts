...
const TALENT_NODES: Talent[] = [
  ...
  { id: "talent_10", name: "Poison Cloud", description: "Apply 1 Poison to all enemies without dealing direct damage.", branch: "shadow", kind: "ability", tier: 6, cost: 1, requires: ["talent_9"], position: { x: 58.06451612903226, y: 56.25 }, icon: "✦", shape: "square", abilityId: "PoisonCloud" },
  { id: "talent_11", name: "Stealth", description: "Enemies cannot target you until the end of your next turn.", branch: "shadow", kind: "ability", tier: 6, cost: 1, requires: ["talent_7"], position: { x: 58.06451612903226, y: 43.75 }, icon: "✦", shape: "square", abilityId: "Stealth" },
  ...
  { id: "talent_34", name: "Fatality", description: "When direct damage brings an enemy below 50% Health, gain Strengthened for 3 turns.", branch: "shadow", kind: "passive", tier: 7, cost: 1, requires: ["talent_11", "talent_10"], position: { x: 58.06451612903226, y: 50 }, icon: "✦", shape: "circle", combat: { triggers: [{ id: "fatality", name: "Fatality", description: "Crossing an enemy below 50% Health grants Strengthened.", event: "on_hit", conditions: { targetHealthCrossedBelow: 0.5 }, effects: [{ type: "apply_status", status: createStatusEffect("strengthened"), target: "self" }] }] } },
