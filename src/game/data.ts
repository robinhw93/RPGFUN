...
export const ENEMIES: Record<string, EnemyTemplate> = {
  dummy: { id: "dummy", name: "DUMMY", title: "Training Construct", maxHp: 100, physicalPower: 1, spellPower: 0, armor: 0, magicResistance: 0, hitChance: 0.95, dodgeChance: 0, critChance: 0, energyRegen: 1, maxEnergy: 10, abilities: [{ id: "trainingStrike", name: "Training Strike", description: "A harmless training strike with 95% Hit Chance that deals 1 Physical Damage. Costs 1 Energy.", energyCost: 1, damageType: "physical", physicalPowerScaling: 1 }], abilitiesNotes: "Training Strike: 100% Physical Power as Physical damage.", behaviorNotes: "Uses Training Strike whenever it has enough Energy.", accent: "#a8a69d" },
  ashHound: { id: "ashHound", name: "Ash Hound", title: "Feral Beast", maxHp: 28, physicalPower: 7, spellPower: 0, armor: 1, magicResistance: 0, hitChance: 0.95, dodgeChance: 0.08, critChance: 0, energyRegen: 1, maxEnergy: 10, abilities: [{ id: "rakingClaws", name: "Raking Claws", description: "Rakes the target with ash-caked claws. Deals 100% Physical Power as Physical Damage, costs 3 Energy, and applies Bleed when it deals Health damage.", energyCost: 3, damageType: "physical", physicalPowerScaling: 1, onHitEffect: "bleed" }], abilitiesNotes: "Raking Claws: 100% Physical Power as Physical damage and applies Bleed when it deals Health damage.", behaviorNotes: "Uses Raking Claws whenever it has enough Energy.", accent: "#d47a43" },
  cinderCultist: { id: "cinderCultist", name: "Cinder Cultist", title: "Fanatic", maxHp: 34, physicalPower: 0, spellPower: 9, armor: 2, magicResistance: 2, hitChance: 0.96, dodgeChance: 0.03, critChance: 0, energyRegen: 1, maxEnergy: 10, abilities: [{ id: "searingBrand", name: "Searing Brand", description: "Brands the target with a searing sigil. Deals 100% Spell Power as Arcane Damage and costs 4 Energy.", energyCost: 4, damageType: "arcane", spellPowerScaling: 1 }], abilitiesNotes: "Searing Brand: 100% Spell Power as Arcane damage.", behaviorNotes: "Uses Searing Brand whenever it has enough Energy.", accent: "#a46ad4" },
  emberWisp: { id: "emberWisp", name: "Ember Wisp", title: "Restless Flame", maxHp: 22, physicalPower: 0, spellPower: 6, armor: 0, magicResistance: 3, hitChance: 0.98, dodgeChance: 0.12, critChance: 0, energyRegen: 1, maxEnergy: 10, abilities: [{ id: "scorch", name: "Scorch", description: "Releases a focused burst of living flame. Deals 100% Spell Power as Arcane Damage and costs 3 Energy.", energyCost: 3, damageType: "arcane", spellPowerScaling: 1 }], abilitiesNotes: "Scorch: 100% Spell Power as Arcane damage.", behaviorNotes: "Uses Scorch whenever it has enough Energy.", accent: "#d6ad53" },
  ashenWarden: { id: "ashenWarden", name: "The Ashen Warden", title: "Keeper of the Black Gate", maxHp: 92, physicalPower: 12, spellPower: 0, armor: 4, magicResistance: 4, hitChance: 1, dodgeChance: 0.05, critChance: 0, energyRegen: 1, maxEnergy: 10, abilities: [{ id: "cinderCleave", name: "Cinder Cleave", description: "Sweeps a burning blade across the battlefield. Deals 100% Physical Power as Physical Damage and costs 5 Energy.", energyCost: 5, damageType: "physical", physicalPowerScaling: 1 }], abilitiesNotes: "Cinder Cleave: 100% Physical Power as Physical damage.", behaviorNotes: "Uses Cinder Cleave whenever it has enough Energy.", accent: "#de5b47" },
  windsongWolf: { id: "windsongWolf", name: "Windsong Wolf", title: "Forest Hunter", maxHp: 30, physicalPower: 7, spellPower: 0, armor: 1, magicResistance: 0, hitChance: 0.94, dodgeChance: 0.1, critChance: 0.05, energyRegen: 1, maxEnergy: 10, abilities: [{ id: "rendingBite", name: "Rending Bite", description: "Lunges from the undergrowth with a tearing bite. Deals 100% Physical Power as Physical Damage, costs 3 Energy, and applies Bleed when it deals Health damage.", energyCost: 3, damageType: "physical", physicalPowerScaling: 1, onHitEffect: "bleed" }], abilitiesNotes: "Rending Bite: 100% Physical Power as Physical damage and applies Bleed when it deals Health damage.", behaviorNotes: "Uses Rending Bite whenever it has enough Energy.", accent: "#79a86d" },
  groveSprite: { id: "groveSprite", name: "Grove Sprite", title: "Wayward Spirit", maxHp: 24, physicalPower: 0, spellPower: 7, armor: 0, magicResistance: 4, hitChance: 0.97, dodgeChance: 0.14, critChance: 0.08, energyRegen: 2, maxEnergy: 12, abilities: [{ id: "pollenSpark", name: "Pollen Spark", description: "Fires a bright knot of forest magic. Deals 100% Spell Power as Arcane Damage and costs 4 Energy.", energyCost: 4, damageType: "arcane", spellPowerScaling: 1 }], abilitiesNotes: "Pollen Spark: 100% Spell Power as Arcane damage.", behaviorNotes: "Uses Pollen Spark whenever it has enough Energy.", accent: "#b7cf6a" },
  greybackBoar: { id: "greybackBoar", name: "Greyback Boar", title: "Ancient Tusker", maxHp: 82, physicalPower: 11, spellPower: 0, armor: 5, magicResistance: 2, hitChance: 0.93, dodgeChance: 0.03, critChance: 0.1, energyRegen: 1, maxEnergy: 10, abilities: [{ id: "stoneTuskCharge", name: "Stone-Tusk Charge", description: "Crashes forward behind stone-grey tusks. Deals 100% Physical Power as Physical Damage and costs 5 Energy.", energyCost: 5, damageType: "physical", physicalPowerScaling: 1 }], abilitiesNotes: "Stone-Tusk Charge: 100% Physical Power as Physical damage.", behaviorNotes: "Uses Stone-Tusk Charge whenever it has enough Energy.", accent: "#9a9888" },
};
