...
export const ABILITIES: Record<string, Ability> = {
  ...
  Recouperate: {
    id: "Recouperate", name: "Recouperate", description: "Restore 50% of your maximum Energy.", energyCost: 1,
...
const TALENT_NODES: Talent[] = [
  ...
  { id: "talent_34", name: "Recouperate", description: "Restore 50% of your maximum Energy.", branch: "shadow", kind: "ability", tier: 7, cost: 1, requires: [], position: { x: 58.06451612903226, y: 50 }, icon: "✦", shape: "square", abilityId: "Recouperate" },
  ...
  { id: "talent_43", name: "Distraction", description: "Killing an enemy grants Stealth for 1 turn and makes your next ability cost 0 Energy.", branch: "shadow", kind: "passive", tier: 11, cost: 1, requires: ["talent_37"], position: { x: 78.2258064516129, y: 45.3125 }, icon: "✦", shape: "circle", combat: { triggers: [{ id: "distraction", name: "Distraction", description: "Killing an enemy grants Stealth and makes your next ability free.", event: "on_kill", effects: [{ type: "apply_status", status: createStatusEffect("stealth", { duration: 1 }), target: "self" }, { type: "apply_status", status: createStatusEffect("distraction", { duration: 1 }), target: "self" }] }] } },
