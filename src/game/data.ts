...
export const ABILITIES: Record<string, Ability> = {
  ...
  ElementalFury: {
    range: "ranged",
    id: "ElementalFury", name: "Elemental Fury", description: "Deal Arcane Damage equal to 50% of your Magical Power. If the target has no debuffs, apply 2 Burn, Electrified, Slowed, Exhausted, and 2 Arcane Wounds. Otherwise, deal 50% more damage per unique debuff on the target.", energyCost: 3,
  ...
  DivineSmite: {
    ...
    id: "DivineSmite", name: "Divine Smite", description: "Deal Magic Damage equal to 100% of your Magical Power and apply Smite for 3 turns.", energyCost: 5,
  ...
  ConsecratedGround: {
    range: "ranged", rangedPresentation: "target",
    id: "ConsecratedGround", name: "Consecrated Ground", description: "Deal Magic Damage equal to 80% of your Magical Power to all enemies. Each enemy has a 20% chance to gain Smite. Gain Regenerate.", energyCost: 6,
...
const TALENT_NODES: Talent[] = [
  ...
  { id: "talent_40", name: "Resistance", description: "You are immune to Poison.\n+10 Magical Power.", branch: "shadow", kind: "passive", tier: 12, cost: 1, requires: ["talent_35"], position: { x: 78.2258064516129, y: 64.84375 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 10, statusImmunities: ["poison"] } } },
  { id: "talent_41", name: "Thunderstruck", description: "You are immune to Electrified.\n+20 Magical Power.", branch: "shadow", kind: "passive", tier: 12, cost: 1, requires: ["talent_36"], position: { x: 78.2258064516129, y: 35.15625 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 20, statusImmunities: ["electrified"] } } },
  ...
  { id: "talent_190", name: "Magical Fires", description: "Burning Guard gains additional Guard equal to 50% of your Magical Power.", branch: "brute", kind: "passive", tier: 9, cost: 1, requires: ["talent_186"], position: { x: 13.095238095238097, y: 49.43181818181818 }, icon: "✦", shape: "circle", combat: { abilityModifiers: [{ id: "magical-fires", name: "Magical Fires", description: "Burning Guard also scales with 50% of your Magical Power.", abilityIds: ["BurningGuard"], selfGuardMagicalPowerScalingBonus: 0.5, descriptionOverride: "Gain Guard equal to 50% of your Physical Power plus 50% of your Magical Power for 1 turn. If this Guard is destroyed, apply 3 Burn to the attacker." }] } },
  { id: "talent_191", name: "Cleansing Hands", description: "Lay on Hands also removes every debuff from you.\n+10% Magical Power.", branch: "brute", kind: "passive", tier: 10, cost: 1, requires: ["talent_187"], position: { x: 13.095238095238097, y: 77.8409090909091 }, icon: "✦", shape: "circle", combat: { passive: { magicalPowerMultiplier: 0.1 }, abilityModifiers: [{ id: "cleansing-hands", name: "Cleansing Hands", description: "Lay on Hands removes every debuff from you.", abilityIds: ["LayOnHands"], removeAllSelfDebuffs: true, descriptionOverride: "Restore 10% of your maximum Health, gain Barrier equal to the Health restored, and remove every debuff from yourself." }] } },
  ...
  { id: "talent_199", name: "Divine Smite", description: "Deal 100% Magical Power as Magic Damage and apply Smite for 3 turns.", branch: "brute", kind: "ability", tier: 12, cost: 1, requires: ["talent_194"], position: { x: 13.095238095238097, y: 85.22727272727273 }, icon: "✦", shape: "square", abilityId: "DivineSmite", effectNotes: "Smite causes the target to take Magic Damage equal to 50% of the Health the player restores. It lasts for 3 turns." },
  ...
  { id: "talent_218", name: "Imbued Weapon", description: "Searing Strike scales with Magical Power instead, costs 1 less Energy, has a 1-turn cooldown, and applies 2 Burn.", branch: "brute", kind: "passive", tier: 14, cost: 1, requires: ["talent_201"], position: { x: 28.421, y: 40.5 }, icon: "✦", shape: "circle", combat: { abilityModifiers: [{ id: "imbued-weapon", name: "Imbued Weapon", description: "Searing Strike scales with Magical Power, costs 2 Energy, has a 1-turn cooldown, and applies 2 Burn.", abilityIds: ["SearingStrike"], energyCostDelta: -1, cooldownTurnsDelta: -2, powerSourceOverride: "magical", statusStacks: 2, descriptionOverride: "Deal Physical Damage equal to {powerScalingPercent}% of your {powerSourceLabel} and apply {primaryStatusStacks} Burn." }] } },
  ...
  { id: "talent_235", name: "Oath 1", description: "+5% Magical Power.", branch: "brute", kind: "passive", tier: 13, cost: 1, requires: ["talent_199"], position: { x: 20.526315789473685, y: 75 }, icon: "✦", shape: "circle", combat: { passive: { magicalPowerMultiplier: 0.05 } } },
  { id: "talent_236", name: "Oath 2", description: "+5% Magical Power.", branch: "brute", kind: "passive", tier: 14, cost: 1, requires: ["talent_235"], position: { x: 17.894736842105264, y: 75 }, icon: "✦", shape: "circle", combat: { passive: { magicalPowerMultiplier: 0.05 } } },
  { id: "talent_237", name: "Oath 3", description: "+10% Magical Power.", branch: "brute", kind: "passive", tier: 15, cost: 1, requires: ["talent_236"], position: { x: 17.894736842105264, y: 78.5 }, icon: "✦", shape: "circle", combat: { passive: { magicalPowerMultiplier: 0.1 } } },
  { id: "talent_238", name: "Oath 4", description: "+15% Magical Power.", branch: "brute", kind: "passive", tier: 16, cost: 1, requires: ["talent_237"], position: { x: 17.894736842105264, y: 82 }, icon: "✦", shape: "circle", combat: { passive: { magicalPowerMultiplier: 0.15 } } },
  { id: "talent_239", name: "Emberfused 1", description: "+5 Magical Power.\n+2% Physical Power.", branch: "brute", kind: "passive", tier: 12, cost: 1, requires: ["talent_198"], position: { x: 20.526315789473685, y: 37 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 5, physicalPowerMultiplier: 0.02 } } },
  { id: "talent_240", name: "Emberfused 2", description: "+5 Magical Power.\n+2% Physical Power.", branch: "brute", kind: "passive", tier: 13, cost: 1, requires: ["talent_239"], position: { x: 17.894736842105264, y: 37 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 5, physicalPowerMultiplier: 0.02 } } },
  { id: "talent_241", name: "Emberfused 3", description: "+10 Magical Power.\n+4% Physical Power.", branch: "brute", kind: "passive", tier: 14, cost: 1, requires: ["talent_240"], position: { x: 17.894736842105264, y: 33.5 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 10, physicalPowerMultiplier: 0.04 } } },
  { id: "talent_242", name: "Emberfused 4", description: "+15 Magical Power.\n+5% Physical Power.", branch: "brute", kind: "passive", tier: 15, cost: 1, requires: ["talent_241"], position: { x: 17.894736842105264, y: 30 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 15, physicalPowerMultiplier: 0.05 } } },
  { id: "talent_243", name: "Mystic Power 1", description: "+5 Magical Power.", branch: "arcanist", kind: "passive", tier: 4, cost: 1, requires: ["talent_81", "talent_80"], position: { x: 44.21052631578947, y: 40.5 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 5 } } },
  { id: "talent_244", name: "Mystic Power 2", description: "+5 Magical Power.", branch: "arcanist", kind: "passive", tier: 5, cost: 1, requires: ["talent_243"], position: { x: 44.21052631578947, y: 37.5 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 5 } } },
  { id: "talent_245", name: "Mystic Power 3", description: "+5 Magical Power.", branch: "arcanist", kind: "passive", tier: 6, cost: 1, requires: ["talent_244"], position: { x: 44.21052631578947, y: 34.5 }, icon: "✦", shape: "circle", combat: { passive: { magicalPower: 5 } } },
  { id: "talent_246", name: "Mystic Power 4", description: "+10% Magical Power.", branch: "arcanist", kind: "passive", tier: 7, cost: 1, requires: ["talent_245", "talent_107", "talent_106"], position: { x: 44.21052631578947, y: 31.5 }, icon: "✦", shape: "circle", combat: { passive: { magicalPowerMultiplier: 0.1 } } },
  ...
  { id: "talent_257", name: "Spellblade", description: "+20% Magical Power.", branch: "shadow", kind: "passive", tier: 13, cost: 1, requires: ["talent_41"], position: { x: 76.31578947368422, y: 44 }, icon: "✦", shape: "circle", combat: { passive: { magicalPowerMultiplier: 0.2 } } },
  { id: "talent_258", name: "Study", description: "+10% Magical Power.\n+5 Intelligence.", branch: "shadow", kind: "passive", tier: 13, cost: 1, requires: ["talent_40"], position: { x: 76.31578947368422, y: 68 }, icon: "✦", shape: "circle", combat: { passive: { stats: { intelligence: 5 }, magicalPowerMultiplier: 0.1 } } },
];
