...
export const ABILITIES: Record<string, Ability> = {
  ...
  Bloodbath: {
    range: "melee",
    id: "Bloodbath", name: "Bloodbath", description: "Strike 5 times, choosing a random enemy for each hit. Each hit deals Physical Damage equal to 50% of your Physical Power and applies 1 Bleed.", energyCost: 0,
    target: "enemy", damageType: "physical", powerScaling: 0.5, hits: 5, randomTargetPerHit: true, statusApplications: [{ status: "bleed" }], icon: "✦", branch: "brute", vfx: "bloodbath",
  },
  FurnaceBreaker: {
    range: "melee",
...
const TALENT_NODES: Talent[] = [
  ...
  { id: "talent_178", name: "Quick Guard", description: "Shield Bash costs 1 less Energy.", branch: "brute", kind: "passive", tier: 8, cost: 1, requires: ["talent_176", "talent_183"], position: { x: 16.071428571428573, y: 57.38636363636363 }, icon: "✦", shape: "circle", combat: { abilityModifiers: [{ id: "quick-guard", name: "Quick Guard", description: "Shield Bash costs 1 less Energy.", abilityIds: ["ShieldBash"], energyCostDelta: -1 }] } },
  { id: "talent_179", name: "Bloodier-Letting", description: "Bloodletting now applies 1 Bleed for every 2 Bleed on the target, down from 3.", branch: "brute", kind: "passive", tier: 8, cost: 1, requires: ["talent_177", "talent_181"], position: { x: 16.071428571428573, y: 69.31818181818183 }, icon: "✦", shape: "circle", combat: { abilityModifiers: [{ id: "bloodier-letting", name: "Bloodier-Letting", description: "Bloodletting applies 1 Bleed per 2 existing Bleed.", abilityIds: ["Bloodletting"], statusStacksPerTargetStatusDivisor: 2, descriptionOverride: "Deal 75% Physical Power as damage and apply 1 Bleed for every 2 Bleed already on the target. Applying at least 3 Bleed immediately triggers its Bleed damage once." }] } },
  { id: "talent_180", name: "Light Metal", description: "Swift Blade now grants +2 Energy regeneration next turn, up from +1.", branch: "brute", kind: "passive", tier: 8, cost: 1, requires: ["talent_171", "talent_179"], position: { x: 16.071428571428573, y: 73.86363636363636 }, icon: "✦", shape: "circle", combat: { abilityModifiers: [{ id: "light-metal", name: "Light Metal", description: "Swift Blade grants +2 Energy regeneration next turn.", abilityIds: ["SwiftBlade"], nextTurnEnergyRegenOnHitBonus: 1, descriptionOverride: "Deal 40% Physical Power as damage and gain +2 Energy regeneration next turn." }] } },
  ...
  { id: "talent_185", name: "Blood Barrier", description: "Consume up to 5 Bleed from the target. Gain Guard equal to 10% of your maximum Health per stack consumed.", branch: "brute", kind: "ability", tier: 8, cost: 1, requires: ["talent_181"], position: { x: 13.095238095238097, y: 65.3409090909091 }, icon: "✦", shape: "square", abilityId: "BloodBarrier" },
  ...
  { id: "talent_188", name: "Thick Blood", description: "Blood Barrier no longer consumes Bleed.", branch: "brute", kind: "passive", tier: 9, cost: 1, requires: ["talent_185"], position: { x: 13.095238095238097, y: 69.31818181818183 }, icon: "✦", shape: "circle", combat: { abilityModifiers: [{ id: "thick-blood", name: "Thick Blood", description: "Blood Barrier no longer consumes Bleed.", abilityIds: ["BloodBarrier"], retainTargetStatusOnConsume: true, descriptionOverride: "Draw on up to 5 Bleed from the target without consuming it. Gain Guard equal to 10% of your maximum Health per stack." }] } },
