...
const TALENT_NODES: Talent[] = [
  ...
  { id: "talent_65", name: "Panic", description: "The first time you would die each combat, restore 20% of your maximum Health and gain Stealth until the end of your next turn.", branch: "shadow", kind: "passive", tier: 14, cost: 1, requires: ["talent_61"], position: { x: 90.32258064516128, y: 50 }, icon: "✦", shape: "circle", combat: { passive: { deathPreventionHealRatio: 0.2, deathPreventionStealthDuration: 2 } } },
  ...
  { id: "talent_81", name: "Arcane Blast", description: "Deal 20% Spell Power as Arcane Damage plus an additional 10% Spell Power per existing Arcane Wound, then apply 1 Arcane Wound.", branch: "arcanist", kind: "ability", tier: 3, cost: 1, requires: ["talent_79"], position: { x: 25.34246575342466, y: 31.25 }, icon: "✦", shape: "square", abilityId: "ArcaneBlast", effectNotes: "Arcane Wound lasts 3 turns. Each existing stack adds 10% Spell Power to Arcane Blast before the new stack is applied." },
  ...
  { id: "talent_106", name: "Arcane Knowledge", description: "+2 Intelligence. Each Arcane Wound adds 15% of your Spell Power to Arcane Blast instead of 10%.", branch: "arcanist", kind: "passive", tier: 8, cost: 1, requires: ["talent_102"], position: { x: 25.34246575342466, y: 24.342105263157894 }, icon: "✦", shape: "circle", combat: { passive: { stats: { intelligence: 2 } }, abilityModifiers: [{ id: "arcane-knowledge", name: "Arcane Knowledge", description: "Arcane Wounds grant Arcane Blast an additional 5% Spell Power scaling per stack.", abilityIds: ["ArcaneBlast"], damagePerTargetStatusStackPowerScalingDelta: 0.05, descriptionOverride: "Deal Arcane Damage equal to 20% of your Spell Power plus an additional 15% of your Spell Power per existing Arcane Wound, then apply 1 Arcane Wound." }] } },
...
export const ENEMIES: Record<string, EnemyTemplate> = {
  dummy: { id: "dummy", name: "DUMMY", title: "Training Construct", imageUrl: "/assets/enemies/full/dummy.webp", portraitUrl: "/assets/enemies/portraits/dummy.webp", maxHp: 100, physicalPower: 1, spellPower: 0, armor: 0, magicResistance: 0, hitChance: 0.95, dodgeChance: 0, critChance: 0, energyRegen: 1, maxEnergy: 10, abilities: [{ id: "trainingStrike", name: "Training Strike", description: "Deals 1 base Physical damage.", energyCost: 1, cooldownTurns: 0, range: "melee", damageType: "physical", baseDamage: 1, vfx: "enemy_training_strike" }], behaviorNotes: "Uses Training Strike whenever it has enough Energy.", behavior: "single", maxActionsPerTurn: 1, accent: "#a8a69d" },
  "enemy-mrxiut2a-k4kgv": { id: "enemy-mrxiut2a-k4kgv", name: "Rabid Rat", title: "Creature", imageUrl: "/assets/enemies/full/rabid-rat.webp", portraitUrl: "/assets/enemies/portraits/rabid-rat.webp", maxHp: 8, physicalPower: 1, spellPower: 0, armor: 0, magicResistance: 0, hitChance: 0.95, dodgeChance: 0.05, critChance: 0.1, energyRegen: 1, maxEnergy: 3, abilities: [
  ...
  "enemy-mrxj4o6o-o45ia": { id: "enemy-mrxj4o6o-o45ia", name: "Windsong Wolf", title: "Creature", imageUrl: "/assets/enemies/full/windsong-wolf.webp", portraitUrl: "/assets/enemies/portraits/windsong-wolf.webp", maxHp: 17, physicalPower: 3, spellPower: 0, armor: 1, magicResistance: 0, hitChance: 0.95, dodgeChance: 0.1, critChance: 0.1, energyRegen: 1, maxEnergy: 6, abilities: [
  ...
  "enemy-mrxk609z-n04fq": { id: "enemy-mrxk609z-n04fq", name: "Forest Wisp", title: "Creature", imageUrl: "/assets/enemies/full/forest-wisp.webp", portraitUrl: "/assets/enemies/portraits/forest-wisp.webp", maxHp: 9, physicalPower: 0, spellPower: 2, armor: 0, magicResistance: 1, hitChance: 0.95, dodgeChance: 0.4, critChance: 0.05, energyRegen: 2, maxEnergy: 5, abilities: [{ id: "enemy-ability-mrxk7ose-fc13q", name: "Wisp Blast", description: "Deals Arcane damage equal to a random 50–100% of Spell Power and has a 10% chance to apply Weaken. When its final blast spends all Energy, the Forest Wisp becomes Stunned for 1 turn.", energyCost: 1, cooldownTurns: 0, range: "ranged", rangedPresentation: "projectile", damageType: "arcane", powerScalingRange: { power: "spell", min: 0.5, max: 1 }, statusApplications: [{ status: "weaken", chance: 0.1 }], selfStatusApplicationsWhenEnergyDepleted: [{ status: "stunned", duration: 2 }], vfx: "enemy_wisp_blast" }], behaviorNotes: "Uses Wisp Blast repeatedly until its Energy is empty, then becomes Stunned for its next turn.", behavior: "wisp_barrage", maxActionsPerTurn: 10, accent: "#79a86d" },
  "enemy-mrxkar5z-g9o5d": { id: "enemy-mrxkar5z-g9o5d", name: "Brown Bear", title: "Creature", imageUrl: "/assets/enemies/full/brown-bear.webp", portraitUrl: "/assets/enemies/portraits/brown-bear.webp", maxHp: 30, physicalPower: 5, spellPower: 0, armor: 5, magicResistance: 0, hitChance: 0.85, dodgeChance: 0.05, critChance: 0.05, energyRegen: 0, maxEnergy: 6, abilities: [
  ...
  "enemy-mrxkjqs3-g7g5i": { id: "enemy-mrxkjqs3-g7g5i", name: "The Forest Spirit", title: "Creature", imageUrl: "/assets/enemies/full/forest-spirit.webp", portraitUrl: "/assets/enemies/portraits/forest-spirit.webp", maxHp: 40, physicalPower: 0, spellPower: 10, armor: 0, magicResistance: 2, hitChance: 0.95, dodgeChance: 0.1, critChance: 0.1, energyRegen: 2, maxEnergy: 10, abilities: [
