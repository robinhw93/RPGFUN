...
export const ENEMIES: Record<string, EnemyTemplate> = {
  ...
  "enemy-mrxiut2a-k4kgv": { id: "enemy-mrxiut2a-k4kgv", name: "Rabid Rat", title: "Creature", maxHp: 7, physicalPower: 2, spellPower: 0, armor: 0, magicResistance: 0, hitChance: 0.95, dodgeChance: 0.05, critChance: 0.1, energyRegen: 1, maxEnergy: 3, abilities: [
  ...
  "enemy-mrxj4o6o-o45ia": { id: "enemy-mrxj4o6o-o45ia", name: "Windsong Wolf", title: "Creature", maxHp: 18, physicalPower: 4, spellPower: 0, armor: 1, magicResistance: 0, hitChance: 0.95, dodgeChance: 0.1, critChance: 0.1, energyRegen: 1, maxEnergy: 6, abilities: [
  ...
  "enemy-mrxk609z-n04fq": { id: "enemy-mrxk609z-n04fq", name: "Forest Wisp", title: "Creature", maxHp: 9, physicalPower: 0, spellPower: 10, armor: 0, magicResistance: 1, hitChance: 0.95, dodgeChance: 0.4, critChance: 0.05, energyRegen: 2, maxEnergy: 5, abilities: [{ id: "enemy-ability-mrxk7ose-fc13q", name: "Wisp Blast", description: "Deals 50% Spell Power as Arcane damage and has a 10% chance to apply Weaken.", energyCost: 1, cooldownTurns: 0, range: "ranged", rangedPresentation: "projectile", damageType: "arcane", spellPowerScaling: 0.5, statusApplications: [{ status: "weaken", chance: 0.1 }], vfx: "enemy_wisp_blast" }], behaviorNotes: "Uses as many Wisp Blasts as its Energy allows each turn.", behavior: "wisp_barrage", maxActionsPerTurn: 10, accent: "#79a86d" },
  "enemy-mrxkar5z-g9o5d": { id: "enemy-mrxkar5z-g9o5d", name: "Brown Bear", title: "Creature", maxHp: 30, physicalPower: 5, spellPower: 0, armor: 5, magicResistance: 0, hitChance: 0.85, dodgeChance: 0.05, critChance: 0.05, energyRegen: 0, maxEnergy: 6, abilities: [
  ...
  "enemy-mrxkjqs3-g7g5i": { id: "enemy-mrxkjqs3-g7g5i", name: "The Forest Spirit", title: "Creature", maxHp: 40, physicalPower: 0, spellPower: 10, armor: 0, magicResistance: 2, hitChance: 0.95, dodgeChance: 0.1, critChance: 0.1, energyRegen: 2, maxEnergy: 10, abilities: [
