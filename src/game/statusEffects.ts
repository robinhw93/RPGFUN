...
export const STATUS_EFFECTS: Record<StatusEffectId, StatusEffectDefinition> = {
  ...
  smite: { id: "smite", name: "Smite", kind: "debuff", duration: DEFAULT_STATUS_DURATION, description: "Whenever the player restores Health from any combat source, take Magic Damage equal to 50% of the Health actually restored." },
