...
- Eight equipment slots, weapon-hand rules, rarity, item comparison, inventory filtering/sorting, combat consumables, ordinary carried items, item prices, independent enemy/stage item drops, and event-driven Wandering Merchants with buying and inventory selling.
