...
- The live item source contains 354 definitions: 277 gear, 41 consumables, and 36 ordinary items. There are 39 sets: twenty-one Adventure 4–12 drop sets with five pieces and executable 2/3/4/5-piece bonuses, plus nine two-piece artisan sets. Every story-adventure completion adds two persistent stock entries to each of the five Arkenfall shops, including 24 class-agnostic specialization rings with executable effects. Epic items begin in Adventure 8; Legendary set pieces, weapons, and vendor stock begin in Adventure 11.
