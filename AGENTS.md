...
- The player-facing story route contains seventeen adventures from Windsong Forest through The Throne Beyond Death. Adventures 4–12 retain their 12–22-stage campaign structure. Adventures 13–17 are five-stage endgame chapters at levels 54–70, each with five dedicated enemies, one event, a boss on stage five, and data-owned card/combat artwork.
- The enemy catalog has 106 templates. All 100 distinct enemies introduced from recommended level 4 onward use data-owned tactical AI editable through Enemy Editor. The 25 Adventure 13–17 enemies have dedicated full artwork and portraits, heavy healing and debuff kits, and five named Resilient support enemies that can resurrect a dead ally at 100% Health.
- The live item source contains 382 definitions: 305 gear, 41 consumables, and 36 ordinary items. There are 43 sets, including four seven-piece Legendary class-focused endgame sets with executable 2/3/4/5/6/7-piece bonuses. The Adventures 1–12 shop track retains its two core persistent stock entries per artisan and 24 class-agnostic specialization rings; the Jeweler additionally sells eight magical arms from Adventures 4 and 6–12 behind their matching completion gates. Epic items begin in Adventure 8; Legendary set pieces, weapons, and vendor stock begin in Adventure 11.
