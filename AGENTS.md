...
- The player-facing story route contains twelve adventures from Windsong Forest through The World Below. Adventures 4–12 have 12–22 stages, seven dedicated enemies, three skill-check events, one tactical final boss, and data-owned card/combat artwork each. Their normal, boss, and event-triggered immediate encounters store a 50% enemy-XP reduction before replay scaling. The Astral Scar and The World Below are the longer level-49/50 endgame chapters.
- The enemy catalog has 81 templates. All 75 distinct enemies introduced from recommended level 4 onward use data-owned tactical AI editable through Enemy Editor. The 63 Adventure 4–12 enemies have dedicated full artwork and portraits, named executable role kits, starting Energy, independent drop rows, and five-ability boss sequences with unique low-Health phases.
- The live item source contains 354 definitions: 277 gear, 41 consumables, and 36 ordinary items. There are 39 sets: twenty-one Adventure 4–12 drop sets with five pieces and executable 2/3/4/5-piece bonuses, plus nine two-piece artisan sets. Every story-adventure completion adds two core persistent stock entries to each of the five Arkenfall shops, including 24 class-agnostic specialization rings with executable effects; the Jeweler additionally sells eight magical arms from Adventures 4 and 6–12 behind their matching completion gates. Epic items begin in Adventure 8; Legendary set pieces, weapons, and vendor stock begin in Adventure 11.
